% Entanglement + tomography pulse sequence with phase tracking. Syntax: 
%
%            echo=entanglement_sequence_wclock(spin_system,parameters,H,R,K)
%
...
function ent=entanglement_sequence_wclock(spin_system,parameters,H,R,K)
...
%First pulse
[rho,P] = double_pulse_xy(spin_system, L, {Ex,Ey}, parameters.rho0, parameters.pulse_pwr(1,1), parameters.pulse_frq(1,1), parameters.pulse_phi(1,1), ...
...
[rho,P] = double_pulse_xy(spin_system, L, {Ex,Ey}, rho, parameters.pulse_pwr(2,1), parameters.pulse_frq(2,1), parameters.pulse_phi(2,1)+phase1, ...
...
[rho,P] = double_pulse_xy(spin_system, L, {Ex,Ey}, rho, parameters.pulse_pwr(3,1), parameters.pulse_frq(3,1), parameters.pulse_phi(3,1)+phase1, ...
